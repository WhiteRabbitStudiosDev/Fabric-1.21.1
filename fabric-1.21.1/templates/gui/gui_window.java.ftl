...
import ${package}.init.${JavaModName}Screens;
import ${package}.world.inventory.${name}Menu;
	...
	@Override public void init() {
		...
		<#list imageButtons as component>
			${component.getName()} = new ImageButton(
				...
				@Override public void renderContents(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
					<#if hasProcedure(component.displayCondition)>
