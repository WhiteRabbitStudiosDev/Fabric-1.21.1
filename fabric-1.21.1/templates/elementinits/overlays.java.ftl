...
@Environment(EnvType.CLIENT) public class ${JavaModName}Overlays {
	...
	private static void register(ResourceLocation resourceLocation, String registryname, HudElement element) {
		HudElementRegistry.attachElementAfter(resourceLocation, ResourceLocation.fromNamespaceAndPath(${JavaModName}.MODID, registryname), element);
	}
